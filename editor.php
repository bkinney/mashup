...
//echo $_REQUEST[];
if(!empty($_REQUEST['custom_redirect'])){
...
/*        paste_postprocess : function(pl, o) {
	...
	templates: [
		...
		save_onsavecallback: function() { 
			...
			if($("#content_url").val().indexOf("http://")>-1 && $("#folder").val().indexOf("/insecure")==-1){
				alert("insecure url: " + $("#content_url").val() + " be sure to open this assignment in a new window."); 
			...
			if($("#title").val()==""){
			  ...
			  // e.preventDefault();
			   ...
			   $("#mce").attr("action","https://apps.ats.udel.edu/canvas/mashup/show.php");
			  $("#mce").submit();
		   }
		   },
	/*	  setup : function(ed) {
...
<form method="post" action="show.php" id="mce">
...
<input id="folder" name="folder"  type="hidden"  value="<?php echo $_SESSION['owner'] ?>" size="20"/>
<p align="center">
